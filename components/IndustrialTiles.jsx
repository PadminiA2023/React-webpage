  ...
  return (
    ...
    >
      ...
      <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 text-gray-300">
        Discover how Industrial Data Fabric bridges the gap between the edge and the enterprise,
        integrating diverse data sources into a unified layer that enables predictive analytics,
        agile decision-making, and resilient operations. Whether you’re driving manufacturing
        efficiency, energy optimization, or smart asset management — this is the platform that
        empowers your teams to act faster and smarter.
      </p>
